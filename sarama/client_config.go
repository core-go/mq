...
type ClientConfig struct {
	ClientID *string `mapstructure:"client_id" json:"clientId,omitempty" gorm:"column:clientid" bson:"clientId,omitempty" dynamodbav:"clientId,omitempty" firestore:"clientId,omitempty"`
	...
	Algorithm string `mapstructure:"algorithm" json:"algorithm,omitempty" gorm:"column:algorithm" bson:"algorithm,omitempty" dynamodbav:"algorithm,omitempty" firestore:"algorithm,omitempty"`

	SASLEnable    *bool `mapstructure:"sasl_enable" json:"saslEnable,omitempty" gorm:"column:saslenable" bson:"saslEnable,omitempty" dynamodbav:"saslEnable,omitempty" firestore:"saslEnable,omitempty"`
	SASLHandshake *bool `mapstructure:"sasl_handshake" json:"saslHandshake,omitempty" gorm:"column:saslhandshake" bson:"saslHandshake,omitempty" dynamodbav:"saslHandshake,omitempty" firestore:"saslHandshake,omitempty"`
	MetadataFull  *bool `mapstructure:"metadata_full" json:"metadataFull,omitempty" gorm:"column:metadatafull" bson:"metadataFull,omitempty" dynamodbav:"metadataFull,omitempty" firestore:"metadataFull,omitempty"`
	...
	Version *sarama.KafkaVersion `mapstructure:"version" json:"version,omitempty" gorm:"column:version" bson:"version,omitempty" dynamodbav:"version,omitempty" firestore:"version,omitempty"`
...
type TLSConfig struct {
	InsecureSkipVerify *bool  `mapstructure:"insecure_skip_verify" json:"insecureSkipVerify,omitempty" gorm:"column:insecureskipverify" bson:"insecureSkipVerify,omitempty" dynamodbav:"insecureSkipVerify,omitempty" firestore:"insecureSkipVerify,omitempty"` // the same with TLSSkipVerify ?
